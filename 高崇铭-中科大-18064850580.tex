...
\cventry{2020.07--至今\\科研实习}{\cu{快手}}{}{}{}{实习导师:\kai{\href{https://hexiangnan.github.io}{\blue{\kai{何向南}}, 江鹏, 李彪}}.\vspace{1mm}\\
...
\cventry{2023.03--至今\\科研实习}{\cu{阿里巴巴 达摩院}}{}{}{}{实习导师:\kai{陈子谦, 高金杨}.\vspace{1mm}\\
实习成果: 社会科学中的博弈与均衡演绎问题。}
\vspace{1mm}

\cventry{2019.03--2019.09\\科研实习}{\cu{阿里巴巴} AI Labs}{}{}{}{实习导师:\kai{王浩, \href{https://sites.google.com/view/hongzhi-yin/home}{\blue{\kai{阴红志}}}, 聂再清}.\vspace{1mm}\\
...
\cventry{SIGIR '23}{\small Alleviating Matthew Effect of Offline Reinforcement Learning in Interactive Recommendation}{}{}{}{\small \cu{\underline{高崇铭}, 黄科鑫, 陈佳伟, 张元, 李彪, 江鹏, 王诗琦, 张众, 何向南}\vspace{1mm}\\
\emph{ACM SIGIR Conference on Research and Development in Information Retrieval} (\textbf{SIGIR '23})\vspace{1mm}\\
(CCF A).\vspace{1mm}\\
工作简介: 探究了离线强化学习中的保守思想在推荐系统问题中引发的问题，并用一种惩罚历史行为的熵的机制，使得新的策略即能推荐准确，又避免形成马太效应。}
\vspace{1mm}

\cventry{TOIS '23}{\small CIRS: Bursting Filter Bubbles by Counterfactual Interactive Recommender System}{}{}{}{\small \cu{\underline{高崇铭}, 雷文强, 陈佳伟, 王诗琦, 何向南, 李师军, 李彪, 张元, 江鹏}\vspace{1mm}\\
\emph{Transactions on Information Systems} (\textbf{TOIS '23})\vspace{1mm}\\
(CCF A).\vspace{1mm}\\
工作简介: 一种离线强化学习在短视频推荐问题中的框架，利用因果推理建模并消除了信息茧房问题。}
\vspace{1mm}

\cventry{WWW '23}{\small On the Theories Behind Hard Negative Sampling for Recommendation}{}{}{}{\small \cu{石文焘, 陈佳伟, 冯福利, 张及之, 吴俊康, \underline{高崇铭}, 何向南}\vspace{1mm}\\
\emph{International World Wide Web Conference, 2023} (\textbf{WWW '23})\vspace{1mm}\\
(CCF A).\vspace{1mm}\\
工作简介: 利用DRO作为中介，从理论上将BPR推荐loss中的负采样与优化One-way Partial AUC（OPAUC）联系在一起。从而得到负采样其实是在优化top-k推荐的结论。}
\vspace{1mm}

\cventry{CIKM '22\\(Resource Paper)}{\small KuaiRand: An Unbiased Sequential Recommendation Dataset with Randomly Exposed Videos}{}{}{}{\small \cu{\underline{高崇铭}, 李师军, 张元, 陈佳伟, 李彪, 何向南, 雷文强, 江鹏}\vspace{1mm}\\
\emph{International Conference on Information and Knowledge Management, 2022} (\textbf{CIKM '22})\vspace{1mm}\\
(CCF B).\vspace{1mm}\\
工作简介: 在快手的普通视频推荐流中插入了随机推荐的视频。并对所有交互收集了用户的12种反馈信号。发布了一个非常全面的视频推荐数据集。}
\vspace{1mm}

\cventry{CIKM '22}{\small KuaiRec: A Fully-observed Dataset and Insights for Evaluating Recommender Systems}{}{}{}{\small \cu{\underline{高崇铭}, 李师军, 雷文强, 李彪, 江鹏, 陈佳伟, 何向南, 毛佳昕}, Tat-Seng Chua\vspace{1mm}\\
\emph{International Conference on Information and Knowledge Management, 2022} (\textbf{CIKM '22})\vspace{1mm}\\
(CCF B).\vspace{1mm}\\
工作简介: 提出了快手真实场景中一个全曝光数据集KuaiRec，其中每个用户在每个商品上都有反馈。这一全曝光矩阵可用作推荐系统的无偏评测。}
\vspace{1mm}
...
\section{\cu{获奖情况}}
\cvitem{2023}{\small SIGIR '23 (CCF A){学生旅行奖}。} 
...
\cvitem{编程}{Python, \textsc{Matlab}, \textsc{Java}, C/C++, HTML5+CSS3+Javascript}
\cvitem{排版}{\LaTeX, Adobe Illustrator, Adobe Photoshop}
