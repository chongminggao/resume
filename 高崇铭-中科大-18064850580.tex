...
\cventry{TOIS '23\\Under review}{\small CIRS: Bursting Filter Bubbles by Counterfactual Interactive Recommender System}{}{}{}{\small \cu{\underline{高崇铭}, 雷文强, 陈佳伟, 王诗琦, 何向南, 李师军, 李彪, 张元, 江鹏}\vspace{1mm}\\
\emph{Transactions on Information Systems} (\textbf{TOIS '23})\vspace{1mm}\\
(CCF A).\vspace{1mm}\\
工作简介: 一种离线强化学习在短视频推荐问题中的框架，利用因果推理去除了过滤泡效应。}
\vspace{1mm}
...
\cventry{CIKM '22}{\small KuaiRand: An Unbiased Sequential Recommendation Dataset with Randomly Exposed Videos}{}{}{}{\small \cu{\underline{高崇铭}, 李师军, 张元, 陈佳伟, 李彪, 何向南, 雷文强, 江鹏}\vspace{1mm}\\
